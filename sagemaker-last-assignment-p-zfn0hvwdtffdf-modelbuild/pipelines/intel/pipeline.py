...
def get_pipeline(
    ...
    print("This time model-package group name will be: ", model_package_group_name)
...
#     BAse dir:  /root/.pyenv/versions/3.8.13/lib/python3.8/site-packages/pipelines/intel
# What is in the scripts directory:  /root/.pyenv/versions/3.8.13/lib/python3.8/site-packages/pipelines/intel/pipelines/intel/scripts
# Where are we:  /root/.pyenv/versions/3.8.13/lib/python3.8/site-packages/pipelines/intel/scripts
# What is in the directory:  ['.coveragerc', '.gitignore', '.ipynb_checkpoints', '.pydocstylerc', 'CONTRIBUTING.md', 'LICENSE', 'README.md', 'codebuild-buildspec.yml', 'img', 'pipelines', 'sagemaker-pipelines-project.ipynb', 'setup.cfg', 'setup.py', 'tests', 'tox.ini']
# Name of current file:  /root/.pyenv/versions/3.8.13/lib/python3.8/site-packages/pipelines/intel/pipeline.py
# What is in the current directory:  ['__init__.py', 'pipeline.py', 'scripts', '__pycache__']
    
    print("BAse dir: ", BASE_DIR)
    try:
        print("What is in the scripts directory: ",os.listdir(os.path.join(BASE_DIR, "scripts/")))
    except:
        print("Didn't work, What is in the scripts directory")
        
    try:
        print("What is in the scripts directory: ",os.listdir(os.path.join(BASE_DIR, "scripts/package/")))
    except:
        print("Didn't work, What is in the scripts directory")
    
    try:
        print("What is in the base directory: ",os.listdir(BASE_DIR))
    except:
        print("didn't work BASE_DIR")
